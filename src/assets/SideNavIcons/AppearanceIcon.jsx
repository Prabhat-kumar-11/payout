...
function AppearanceIcon(props) {
  return (
    <svg width={20} height={20} fill="none" {...props}>
      <g opacity={0.8} clipPath="url(#prefix__clip0_84871_2403)" fill="#fff">
        <path d="M4.875 10.589a1.375 1.375 0 100-2.75 1.375 1.375 0 000 2.75zM9 5.464a1.375 1.375 0 11-2.75 0 1.375 1.375 0 012.75 0zM12.375 6.839a1.375 1.375 0 100-2.75 1.375 1.375 0 000 2.75zM16.5 9.214a1.375 1.375 0 11-2.75 0 1.375 1.375 0 012.75 0z" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <defs>
        <clipPath id="prefix__clip0_84871_2403">
